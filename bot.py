...
from admin_panel import get_web_panel_bind, is_web_panel_enabled, start_background_web_panel
...
@bot.event
async def on_ready():
    if is_web_panel_enabled() and not getattr(bot, 'admin_panel_runner', None):
        try:
